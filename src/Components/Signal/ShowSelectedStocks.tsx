    ...
    <div className="show-selected-stocks-container">
      ...
      <div className="show-selected-stocks-list">
        {stockList.map((stock: any) => (
          <div
            key={stock}
            className="show-selected-stocks-row animate__animated animate__fadeIn"
          >
            <span className="mr-3">{stock}</span>
            <button
              className="show-selected-stocks-button"
              onClick={() => handleCutStock(stock)}
            >
              x
            </button>
          </div>
